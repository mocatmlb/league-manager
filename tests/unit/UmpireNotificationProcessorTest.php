...
function umpire_notification_row(int $notificationId, string $email): array {
    return [
...
register_test('23.5 processor records per-row failure and continues later rows', function () {
    ...
    assert_true(isset($db->updateRows[0]['data']['failed_at']), 'Expected failed_at on failed row');
