...
@include_once EnvLoader::getPath('includes/ChatService.php');
...
$model = getSetting('ai_model', 'gemini-1.5-flash');
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="ai_model" class="form-select">
                            <option value="gemini-1.5-flash" <?php echo $model === 'gemini-1.5-flash' ? 'selected' : ''; ?>>Gemini 1.5 Flash (Fast, Free Tier)</option>
                            <option value="gemini-1.5-pro" <?php echo $model === 'gemini-1.5-pro' ? 'selected' : ''; ?>>Gemini 1.5 Pro (Higher Quality)</option>
                            <option value="gemini-2.0-flash" <?php echo $model === 'gemini-2.0-flash' ? 'selected' : ''; ?>>Gemini 2.0 Flash (Latest)</option>
                        </select>
                        <div class="form-text">Flash models have generous free tiers. Pro may incur costs.</div>
                    </div>
